...
app.post('/account', (request, response) => {
    ...
    const alreadExists = customers.some((customer) => customer.cpf === cpf);
...
app.post('/:cpf/withdraw', verifyIfExistsAccountCPF, (request, response) => {
...
app.get('/:cpf/balance', verifyIfExistsAccountCPF, (request, response) => {
    const { customer } = request;
